...
class Services(models.Model):
    ...
    oe = models.CharField(choices=OE, max_length=50, default="NO CONTRACT NEEDED",
                          help_text="Associate Contract From OE")
...
class Test(Status, Extra, models.Model):
    ...
    _is_attendance_required = models.BooleanField(default=False,
                                                  verbose_name="Attendance Required for Associated Session only")
    _is_attendance_required_cr = models.BooleanField(default=False,
                                                     verbose_name="Attendance Required for Preceding and Associated CR Sessions")
    _is_attendance_required_cr_only = models.BooleanField(default=False,
                                                          verbose_name="Attendance Required for All Preceding CR Sessions Only")
