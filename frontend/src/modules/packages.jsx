...
import { CustomCheckBox, CustomTransfer } from "@/components/form/index.jsx";
    ...
    },
    {
      ...
      render: (access) => (
        <div className={"text-center"}>
          <IconComponent
            className={"text-3xl"}
            icon={access ? <Icons type={"checked"} /> : <Icons type={"cross"} />}
          />
        </div>
      ),
    },
      ...
      render: (item) => {
            ...
            content: (
              ...
              >
                <div className={"space-y-5"}>
                  ...
                  >
                    <Input placeholder={"Service name"} className={"w-full h-[50px]"} />
                  </Form.Item>
        ...
        const onDelete = () => {
          Modal.confirm({
            ...
            onOk: async () => {
              try {
                await requestDelete({ id: item.id }).unwrap();
              } catch (error) {
